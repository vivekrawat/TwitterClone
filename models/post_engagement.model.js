...
/**
 * increase favourite count in post model
 * push notification to user
 * pushes user Id in liked_by in this model
 * @param {*} post_id 
 * @param {*} user_id 
 * @returns 
 */
engageSchema.statics.gotLiked = async function (post_id, user_id) {
    ...
    }, { upsert: true }) //The upsert = true option creates the object if it doesn't exist. defaults to false
}
/**
 * decrease favourite_count by 1 in Post model
 * pull user_id form liked by in this model
 * @param {*} post_id 
 * @param {*} user_id 
 * @returns 
 */
