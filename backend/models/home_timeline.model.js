...
/**
 * @param {Object} first param is object with username or user_id to identify user
 * @param {Number} page page no., 1 by default
 */
...
* adds all posts when new user is followed
 ...
 * bulkRemoveposts
 * 
* removed post when post is deleted
* removes all posts from user if id_post_removed not given i.e friend is removed
